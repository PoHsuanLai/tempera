...
//! ```no_run
//! use bevy::prelude::*;
//! use tempera_settings::{TemperaSettingsPlugin, SettingsTab, TabId, TabLabel, TabOrder};
//!
//! let mut app = App::new();
...
//! *ignorable* rather than wrong — the same doctrine `tempera-input`
...
pub use plugin::TemperaSettingsPlugin;
